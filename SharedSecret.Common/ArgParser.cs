...
namespace SharedSecret.Common
{
    ...
    public class ArgumentsParser
    {
        ...
        List<Argument> activeArguments = new List<Argument>();
        List<ArgumentCollection> acriveCollections = new List<ArgumentCollection>();
    ...
    public class ArgumentCollection : Dictionary<string, Argument>
    {
        ...
        public List<ArgumentCollection> SubCollections { get; private set; } = new List<ArgumentCollection>();
